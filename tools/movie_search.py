"""
Movie Search Tools using TMDb API
Tools for searching and retrieving movie information
"""
...
@tool
def search_movies(query: Optional[str] = None, 
    ...
    Args:
        ...
        region: Region code (e.g., 'GB' for UK, 'FR' for France, 'DE' for Germany)
...
@tool
def get_movie_recommendations(movie_id: Optional[str] = None,
